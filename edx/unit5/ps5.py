...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        lower_dict = {c: lower[(i + shift) % len(lower)] for i, c in enumerate(lower)}
        upper_dict = {c: upper[(i + shift) % len(lower)] for i, c in enumerate(upper)}
    ...
    def apply_shift(self, shift):
        ...
        return "".join(map(lambda c: shift_dict.get(c, c), self.message_text))
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for shift in range(26):
            ...
            print(shifted_message, score)
            if score > best_score:
                best_score = score
                best_shift = shift
                best_message = shifted_message

        return (best_shift, " ".join(best_message))
